...
export default class IndicatorViewPager extends Component {
    ...
    constructor (props) {
        ...
        this._currentIndex = props.inverted ? React.Children.count(props.children) - props.initialPage : props.initialPage
        ...
        return (
            <View style={[styles.container, this.props.style]} >
                <ViewPager
                    ...
                    children = {this.props.children && this.props.inverted ? this.props.children.reverse() : this.props.children}
                />
    ...
    _onPageSelected (params) {
        ...
        this._currentIndex = this.props.inverted ? this._childrenCount - params.position : params.position
    }
    ...
    _renderIndicator () {
        ...
        return React.cloneElement(indicator, {
            ref: INDICATOR_REF,
            pager: this,
            initialPage: this.props.inverted ? this._childrenCount - initialPage:  initialPage
        })
    }
    ...
    _goToNextPage () {
        ...
        if(this.props.inverted){
            nextIndex = this._childrenCount - nextIndex;
            if(this._childrenCount == nextIndex){
                nextIndex = 0;
            }
        }
